...
//获取三个月前日期
+ (NSDate *)getMonthAgoFromNowWithNum:(int)num{
    ...
    [monthComponent setMonth:-num];
    [monthComponent setYear:0];
    [monthComponent setDay:0];
    NSDate *toDate = [calender dateByAddingComponents:monthComponent toDate:date options:0];
    NSDateComponents *component = [calender components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay fromDate:toDate];
    NSDate *threeMonthAgoDate = [calender dateFromComponents:component];
    NSString *dateStr = [formatter stringFromDate:threeMonthAgoDate];
    [formatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    dateStr = [dateStr stringByAppendingString:@" 00:00:00"];
    threeMonthAgoDate = [formatter dateFromString:dateStr];
