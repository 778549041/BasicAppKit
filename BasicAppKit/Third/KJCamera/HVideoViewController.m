...
- (void)viewDidLoad {
    ...
    self.backCenterX.constant = -(Main_Screen_Width/2/2)-image.size.width/2/2;
...
- (IBAction)onEnsureAction:(UIButton *)sender {
    ...
    if (self.saveVideoUrl) {
        WEAK_SELF;
        [MBProgressHUD showMessage:@"视频处理中..."];
...
- (void)changeLayout {
    ...
    self.afreshCenterX.constant = -(Main_Screen_Width/2/2);
    self.ensureCenterX.constant = Main_Screen_Width/2/2;
